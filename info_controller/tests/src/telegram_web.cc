...
namespace gazeta::info_controller
{
  ...
  TEST_F(TestTelegramWeb, ParseElementMessageTimeTest)
  {
    ...
    EXPECT_FALSE(parse_element_message_time(new_article))
        << "Expected parsing of HTTP file 2";

    set_dataset_number(TestTelegramWebDataSets::var1);
    EXPECT_TRUE(parse_element_message_time(new_article))
        << "Expected parsing of HTTP file 2";
  ...
  TEST_F(TestTelegramWeb, parse_element_message_link_test)
  {
    ...
    set_dataset_number(TestTelegramWebDataSets::empty);
    EXPECT_FALSE(parse_element_message_link(new_article))
        << "Expected parsing of HTTP file 2";

    set_dataset_number(TestTelegramWebDataSets::var1);
    EXPECT_TRUE(parse_element_message_link(new_article))
        << "Expected parsing of HTTP file 2";
  ...
  TEST_F(TestTelegramWeb, parse_element_message_text_test)
  {
    ...
    set_dataset_number(TestTelegramWebDataSets::empty);
    EXPECT_FALSE(parse_element_message_text(new_article))
        << "Expected parsing of HTTP file 2";

    set_dataset_number(TestTelegramWebDataSets::var1);
    EXPECT_TRUE(parse_element_message_text(new_article))
        << "Expected parsing of HTTP file 2";
  ...
  TEST_F(TestTelegramWeb, parse_element_message_image_test)
  {
    ...
    set_dataset_number(TestTelegramWebDataSets::empty);
    EXPECT_FALSE(parse_element_message_image(new_article))
        << "Expected parsing of HTTP file 2";
  }
  ...
  TEST_F(TestTelegramWeb, parse_element_message_video_test)
  {
    ...
    set_dataset_number(TestTelegramWebDataSets::empty);
    EXPECT_FALSE(parse_element_message_video(new_article))
        << "Expected parsing of HTTP file 2";
  }
  ...
  TEST_F(TestTelegramWeb, parse_element_message_reply_test)
  {
    ...
    set_dataset_number(TestTelegramWebDataSets::empty);
    EXPECT_FALSE(parse_element_message_reply(new_article))
        << "Expected parsing of HTTP file 2";
  }
